...
class ObjectsChart extends AbstractDecoratorWriter
{
    ...
    protected function writeContentPart(Chart $chart)
    {
        ...
        $this->xmlContent->writeAttribute('xmlns:chartooo', 'http://openoffice.org/3.00/chart');
        $this->xmlContent->writeAttribute('xmlns:drawooo', 'http://openoffice.org/3.00/draw');
