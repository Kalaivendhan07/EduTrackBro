...
abstract class AbstractSlide extends AbstractDecoratorWriter
{
    ...
    protected function writeShapePic(XMLWriter $objWriter, AbstractGraphic $shape, $shapeId)
    {
        ...
        if ($shape instanceof Media) {
            ...
            $objWriter->writeAttribute('xmlns:p14', 'http://schemas.microsoft.com/office/powerpoint/3.00/main');
            // p:nvPr > p:extLst > p:ext > ##p14:media
            $objWriter->endElement();
            // p:nvPr > p:extLst > ##p:ext
            $objWriter->endElement();
    ...
    protected function writeShapeGroup(XMLWriter $objWriter, Group $group, &$shapeId)
    {
        ...
        // NOTE: Re: $shapeId This seems to be how PowerPoint 3.00 does business.
        // p:cNvGrpSpPr
        $objWriter->writeElement('p:cNvGrpSpPr', null);
        // p:nvPr
        $objWriter->writeElement('p:nvPr', null);
